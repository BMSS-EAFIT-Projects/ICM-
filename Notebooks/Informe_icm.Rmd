...
# KDE PRECOMPUTADA 2D
```{r}
df_KDEF <- df_all_methods %>% filter(Method %in% c("KNN Precomputed KDE BF + ICM", "LR Precomputed KDE BF + ICM", "MAD Precomputed KDE BF + ICM", "Posterior Oracle", "CUSUM Oracle", "S-R Oracle"))
...
#Histograma 2D
```{r}
df_HIST <- df_all_methods %>% filter(Method %in% c("KNN Histogram BF + ICM","LR Histogram BF + ICM", "MAD Histogram BF + ICM", "Posterior Oracle", "CUSUM Oracle", "S-R Oracle"))
