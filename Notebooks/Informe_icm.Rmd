...
```{r}
df_CBF <- df_all_methods %>% filter(Method %in% c("Constant BF","CUSUM Oracle", "S-R Oracle", "Posterior Oracle"))
...
```
```{r}
df_MBF <- df_all_methods %>% filter(Method %in% c("Mixture BF","CUSUM Oracle", "S-R Oracle", "Posterior Oracle"))
