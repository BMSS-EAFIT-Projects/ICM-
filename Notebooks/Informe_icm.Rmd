...
#CONSTANT BF 2D
```{r}
df_CBF <- df_all_methods %>% filter(Method %in% c("KNN Constant BF + ICM","LR Constant BF + ICM","MAD Constant BF + ICM","CUSUM Oracle", "S-R Oracle", "Posterior Oracle"))
...
# KDE PRECOMPUTADA 2D
```{r}
df_KDEF <- df_all_methods %>% filter(Method %in% c("KNN Precomputed KDE BF + ICM", "LR Precomputed KDE BF + ICM", "MAD Precomputed KDE BF + ICM","CUSUM Oracle", "S-R Oracle", "Posterior Oracle"))
...
#Histograma 2D
```{r}
df_HIST <- df_all_methods %>% filter(Method %in% c("KNN Histogram BF + ICM", "LR Histogram BF + ICM", "MAD Histogram BF + ICM","CUSUM Oracle", "S-R Oracle", "Posterior Oracle"))
